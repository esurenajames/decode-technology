...
export default function ElevateBenefits() {
    const TRAINEE_BENEFITS = [
        {
            icon: <GlobalOutlined className="text-3xl text-accent" />,
            title: 'Learn Anytime. Anywhere.',
            description: 'Trainees can access course materials and assignments anytime, from any device.'
        },
        {
            icon: <SmileOutlined className="text-3xl text-accent-light" />,
        ...
        <section className="py-16 bg-white">
            ...
            <div className="max-w-5xl mx-auto px-6 mb-32">
                <div className="max-w-3xl mb-16">
                    ...
                    <h2 className="text-4xl md:text-5xl font-bold text-primary mb-6 tracking-tight">
                        Why Trainees Love Our <span className="text-accent">Employee Training Solution</span>
                    </h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {TRAINEE_BENEFITS.map((benefit, idx) => (
                        <div key={idx} className="group p-10 rounded-[40px] border border-gray-100 bg-gray-50/50 hover:bg-white hover:shadow-2xl hover:shadow-gray-200/50 transition-all duration-500">
                            <div className="mb-6">
                                {benefit.icon}
                            </div>
            ...
            <div className="max-w-7xl mx-auto px-6">
                <div className="relative p-12 md:p-20 rounded-[60px] bg-[#1a1a1a] overflow-hidden">
                    ...
                    <div className="absolute bottom-0 left-0 w-96 h-96 bg-accent-light/10 rounded-full blur-[120px] -ml-48 -mb-48" />

                    <div className="relative z-10">
                        <div className="max-w-3xl mb-16">
                            <div className="flex items-center gap-2 mb-6">
                                <CheckCircleFilled className="text-accent text-lg" />
                                <span className="text-accent text-xs font-bold uppercase tracking-widest">Featured Section</span>
                            </div>
                            <h2 className="text-4xl md:text-5xl font-bold text-white mb-6 tracking-tight">
                                Why Our Employee Training Solution is the <span className="text-accent-light">Best for Your Business</span>
                            </h2>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                            {BUSINESS_BENEFITS.map((benefit, idx) => (
                                <div key={idx} className="group p-8 rounded-3xl bg-white/5 border border-white/10 hover:bg-white/10 transition-all duration-500">
                                    <div className="w-12 h-12 rounded-2xl bg-white/10 flex items-center justify-center mb-6 group-hover:bg-accent transition-all duration-300">
                                        <div className="text-accent-light group-hover:text-white transition-colors duration-300">
                                            {benefit.icon}
                                        </div>
                                    </div>
