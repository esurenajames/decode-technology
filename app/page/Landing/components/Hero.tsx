...
import { CalendarOutlined, PlayCircleOutlined, CloseOutlined } from '@ant-design/icons';
        ...
        <>
            ...
            {showVideo && (
                ...
                >
                    ...
                    {/* Video container */}
                    <div
                        className="relative w-full max-w-4xl mx-4 aspect-video rounded-2xl overflow-hidden shadow-2xl animate-[scaleIn_0.3s_cubic-bezier(0.16,1,0.3,1)]"
